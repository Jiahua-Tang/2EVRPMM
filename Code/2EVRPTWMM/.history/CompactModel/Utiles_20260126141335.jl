...
function displayMap()
    ...
    scatter!(plt, x_coor[satellites], y_coor[satellites], 
            legend = false)      
    ...
    scatter!(plt, x_coor[customers], y_coor[customers],
                ...
                marker=:utriangle, markerstrokecolor = :black, 
                markerstrokewidth=0.5, label = "Customers",right_margin=100mm)

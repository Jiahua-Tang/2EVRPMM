...
#            # generateData(instance_size, random_seed)
            ...
            retrieve_solomon_random_data("../../Data/Demo/100/" * fileName * ".txt", 1200, 35)
            println("\n================================================================")
...
#             #=========================================================#
            ...
            global execution_time_total = @elapsed begin
                ...
                println("total execution time solving subproblems : ", round(execution_time_cg_subproblem,digits=2)," seconds")

...
function read_nico_dataset(filename)
    ...
    annotate!(plt, x_text, y_top-4.5, Plots.text("Minimum 2e vehicles required: $(minimum_2e_vehicle_required)", :left, 8, color=:black))
    annotate!(plt, x_text, y_top-6, Plots.text("Microhubs: $minimum_parkings, Total parkings: $nb_parking", :left, 8, color=:black))

...
function select_node_from_tree(node_stack)
    ...
    for node_iter in node_stack 
        ...
        println(node_iter.id , " lb: $(round(node_iter.cgLowerBound,digits=2)), delta: $(round(node_iter.cgLowerBound - base_lb,digits=3)) fs: $(round(node_iter.fractionalScore,digits=3)) score : ",score_iter)
    end

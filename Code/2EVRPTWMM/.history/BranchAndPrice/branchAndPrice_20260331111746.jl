...
function solve_column_generation(route_1e, branchingInfo::BranchingInfo, cgLB, fs, id, parent_id)
    ...
    if isLeaf
        ...
        row_data = [Int(id), Int(parent_id), round(total_obj,digits=3), round(fractionalScore, digits=3), round(total_obj - cgLB,digits=3), round(fractionalScore - fs, digits=3),"Integer"]

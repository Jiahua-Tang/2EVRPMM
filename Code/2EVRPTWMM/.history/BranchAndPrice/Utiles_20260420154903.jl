    ...
    for cust in customers
        for parkingStart in satellites
            for parkingEnd in satellites
                ...
                push!(routes_2e, gererate2eRoute([1, 3, 4, 2, 5, 1] ))
                push!(routes_2e, gererate2eRoute([4, 14, 8, 10, 4]))
                push!(routes_2e, gererate2eRoute([5,6,13,5] ))
                push!(routes_2e, gererate2eRoute([4,18,9,12,15,4] ))
                push!(routes_2e, gererate2eRoute([5,16,17,7,5] ))
end

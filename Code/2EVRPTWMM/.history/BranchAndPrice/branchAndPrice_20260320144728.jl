                        ...
                        if !isnothing(left_child_node) || !isnothing(right_child_node)
                            ...
                            try
                                ...
                                if !isnothing(left_child_node)
                                    ...
                                    grid[base_row_l + 2][child_col] = "Branching node with LB reduction: $(round(lb_red_l, digits=2))"
                                    insert!(grid, base_row_l + 3, ["" for _ in 1:ncols2])
                                    grid[base_row_l + 3][child_col] = "Branching node with FS reduction: $(round(fs_red_l, digits=2))"
                                    insert!(grid, base_row_l + 4, ["" for _ in 1:ncols2])
                                    grid[base_row_l + 4][child_col] = "Total reduction: $(round(total_red_l, digits=2))"
                                end

...
function generate1eRoute(route)
    ...
    return Route(cost, route, length(route), load, b1, a, b2in, b2out, arrival_time,0) 
end
...
function generate2eRoute(route::Vector{Int})
    ...
    return Route(cost, route, length(routes_2e)+1, load, b1, a, b2in, b2out, arrival_time,0) 
end

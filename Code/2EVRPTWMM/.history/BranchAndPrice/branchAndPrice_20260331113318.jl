...
function appendNodeMatrix(y_value, id, parent_id, cgLowerBound, fractionalScore, gradientLB,gradientFSstatus1, status2)
    active_routes = [
        ...
        while !isempty(node_stack) # && num_iter_sp < 51
            ...
            if node.cgLowerBound > upperBound
                ...
                # execution_time = @elapsed begin
                    ...
                    #region: write node matrix
                    appendNodeMatrix(node.y_value, current_node_id+1, current_node_id+2)
                    #endregion

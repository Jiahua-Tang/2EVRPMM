...
function select_node_from_tree(node_stack)
    ...
    for node_iter in node_stack
        ...
        println("node $(node_iter.id) : LB = $(round(node_iter.cgLowerBound, digits=2)), baselb = $(round(base_lb, digits=2)), fractionalScore= $(round(node_iter.fractionalScore, digits=3)) score = $(round(score_iter, digits=3))")
    end

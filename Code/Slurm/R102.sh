...
#SBATCH --job-name=R102C100C50Q50
...
# julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 100/R102.txt , 50 200
julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 50/R102_50.txt 600 50 120 r
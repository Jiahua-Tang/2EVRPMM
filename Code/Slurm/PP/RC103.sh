...
#SBATCH --job-name=RC103C100C50Q50
...
julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 100/RC103.txt , 50 200
julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 50/RC103_50.txt , 50 140
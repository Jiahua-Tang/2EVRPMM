...
#SBATCH --job-name=C105C100C50Q50
...
julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 100/C105.txt , 50 180
julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 50/C105_50.txt , 50 120
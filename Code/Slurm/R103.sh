...
#SBATCH --job-name=R103C100C50Q50
...
julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 100/R103.txt , 50 200
julia /gpfs/users/tangj/2EVRPMM/Code/2EVRPMM-V7-z-2index.jl 50/R103_50.txt , 50 140
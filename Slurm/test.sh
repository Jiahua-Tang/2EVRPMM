...
#SBATCH --job-name=testModulization
#SBATCH --output=/gpfs/users/tangj/2EVRPMM/Result/outputSlurm/%j.%x.out
#SBATCH --error=/gpfs/users/tangj/2EVRPMM/Result/outputSlurm/%j.%x.err  # Capture standard error in a separate file
...
julia /gpfs/users/tangj/2EVRPMM/Code/main.jl
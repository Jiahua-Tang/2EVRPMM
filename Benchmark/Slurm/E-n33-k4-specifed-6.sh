...
#SBATCH --output=/gpfs/workdir/tangj/2EVRPMM/Benchmark/Result/OutputSlurm/output/E-n33-k4/%j.specified.%x.out
#SBATCH --error=/gpfs/workdir/tangj/2EVRPMM/Benchmark/Result/OutputSlurm/err/E-n33-k4/%j.specified.%x.err  # Capture standard error in a separate file
...
julia /gpfs/workdir/tangj/2EVRPMM/Code/CompactModel/main_specified_parking.jl E-n33-k4.txt 4 20000 15 23
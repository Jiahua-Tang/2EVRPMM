...
#SBATCH --output=/gpfs/workdir/tangj/2EVRPMM/Benchmark/Result/OutputSlurm/output/E-n51-k5/%j.random.%x.out
#SBATCH --error=/gpfs/workdir/tangj/2EVRPMM/Benchmark/Result/OutputSlurm/err/E-n51-k5/%j.random.%x.err  # Capture standard error in a separate file
...
julia /gpfs/workdir/tangj/2EVRPMM/Code/CompactModel/main_random_parking.jl E-n51-k5.txt 5 20000 4
